...
* run: 
  * for original: `git clone https://github.com/nvim-lua/kickstart.nvim.git ~/.config/nvim` OR: `gh repo clone nvim-lua/kickstart.nvim`
  * for @yosalama's:  `git clone https://github.com/yosalama/kickstart.nvim.git ~/.config/nvim` 
